...
<body>
    ...
    <br>
    <div class="gestion-ticket">
    <h1>Gestion des Tickets</h1>
    <?php
    $rasult = mysqli_query($con,"SELECT * FROM aide");
    echo "aide";
    while($rew = mysqli_fetch_array($rasult))
    {
        echo "<tr><td>" . $rew['texte'] . "</td><td><br> "; //these are the fields that you have stored in your database table employee
    }
 echo "</table>";
 mysqli_close($con);
?>
